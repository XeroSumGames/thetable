...
// Exported so the session recorder can tell which fetches are ours and
// record only those (lib/recorder.ts, components/Recorder.tsx).
export const SUPABASE_URL = 'https://jbudzglgtxeoaufpejrv.supabase.co'
